...
public class HkpListShapeObject : BaseTagfileObject
{
    ...
    public string CollectionType = string.Empty;
...
{
    public uint UserData;
    public string BvTreeType = string.Empty;
...
public class HkpConvexTranslateShapeObject : BaseTagfileObject
{
    public uint UserData;
    public float Radius;
    public string ChildShape = string.Empty;
...
{
    public uint UserData;
    public string DisableWelding = string.Empty;
    public string CollectionType = string.Empty;
    ...
    public string WeldingType = string.Empty;
