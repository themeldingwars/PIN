...
namespace MyGameServer.Data {
	public class ChassisVisuals : CommonVisuals {
		public ChassisVisuals() {
			Decals.Add( new Decal { ID = 10000, Usage = 0xff, Color = 0xffffffff, Transform = new[] {
				                                                                                        (Half)0.052460, (Half)0.019623, (Half)0.0, (Half)0.007484,
			...
			Patterns.Add( new Pattern { ID = 10022, Usage = 0x0, Transform = new[] {
				                                                                       (Half)0.0, (Half)(ushort)16384u,
				                                                                       (Half)0.0, (Half)0.0
			                                                                       } } );
		}
	}
