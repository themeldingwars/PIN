...
namespace MyGameServer.Test.GSS.Character.BaseController {
	internal static class KeyFrame {
		public static Packet.KeyFrame Test( IPlayer p, IInstance inst ) {
			...
			ret.RotW = 0;
			ret.RotX = 0;
			ret.RotY = 0x3eca06d7; // 0xd7, 0x06, 0xca, 0x3e 0x3eca06d7
			ret.RotZ = 0x3f6b3a6b; // 0x6b, 0x3a, 0x6b, 0x3f 0x3f6b3a6b

			ret.AimX = 0x3f39a261; // 0x61, 0xa2, 0x39, 0x3f 0x3f39a261
			ret.AimY = 0x3f30489a; // 0x9a, 0x48, 0x30, 0x3f 0x3f30489a
			ret.AimZ = 0; // 0
			...
			ret.JumpJetEnergy = cd.MaxJumpJetEnergy;
