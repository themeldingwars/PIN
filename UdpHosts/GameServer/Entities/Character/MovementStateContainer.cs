...
namespace GameServer.Entities.Character
{
    ...
    internal class MovementStateContainer
    {
        ...
        public bool Crouch
        {
            get
            {
                return GetValue(CharMovementState.Crouch);
            }
            set
            {
                SetValue(CharMovementState.Crouch, value);
            }
        }
        ...
        public bool MovementKeys
        {
            get
            {
                return GetValue(CharMovementState.MovementKeys);
            }
            set
            {
                SetValue(CharMovementState.MovementKeys, value);
            }
        }
        ...
        public bool Sprint
        {
            get
            {
                return GetValue(CharMovementState.Sprint);
            }
            set
            {
                SetValue(CharMovementState.Sprint, value);
            }
        }
        ...
        public bool TryingToMove
        {
            get
            {
                return GetValue(CharMovementState.TryingToMove);
            }
            set
            {
                SetValue(CharMovementState.TryingToMove, value);
            }
        }
        ...
        public bool IsMoving
        {
            get
            {
                return GetValue(CharMovementState.IsMoving);
            }
            set
            {
                SetValue(CharMovementState.IsMoving, value);
            }
        }
        ...
        public bool Unk
        {
            get
            {
                return GetValue(CharMovementState.Unk);
            }
            set
            {
                SetValue(CharMovementState.Unk, value);
            }
        }
