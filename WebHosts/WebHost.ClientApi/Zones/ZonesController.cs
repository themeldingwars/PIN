        ...
        var zoneTemp1 = new ZoneSettings
                        {
                            ...
                            RewardWinner =
                                new RewardWinner { Items = Array.Empty<Array>(), Loots = Array.Empty<Array>() },
                            RewardLoser =
                                new RewardLoser { Items = Array.Empty<Array>(), Loots = Array.Empty<Array>() },
                            Images =
                                new ZoneImages
                                {
                                    Thumbnail = "/assets/zones/baneclaw/tbn.png",
                                    Screenshot =
                                        new[] { "/assets/zones/baneclaw/01.png", "/assets/zones/baneclaw/02.png", "/assets/zones/baneclaw/03.png" },
        ...
        var zoneTemp2 = new ZoneSettings
                        {
                            ...
                            RewardWinner = new RewardWinner { Items = Array.Empty<Array>(), Loots = Array.Empty<Array>() },
                            RewardLoser = new RewardLoser { Items = Array.Empty<Array>(), Loots = Array.Empty<Array>() },
                            Images = new ZoneImages
                                     {
                                         Thumbnail = "/assets/zones/kanaloa/tbn.png",
                                         Screenshot = new[] { "/assets/zones/kanaloa/01.png", "/assets/zones/kanaloa/02.png", "/assets/zones/kanaloa/03.png" },
                                         Lfg = "/assets/zones/placeholder-ss.png"
                                     },
                            CertRequirements =
                                new object[]
                            ...
                            DifficultyLevels = new object[]
                                               {
                                                   new DifficultyLevels
                                                   {
                                                       Id = 3721,
                                                       ZoneSettingId = 2721,
                                                       UiString = Zone.UIString.INSTANCE_DIFFICULTY_NORMAL.ToString(),
                                                       MinLevel = 39,
                                                       DifficultyKey = Zone.DifficultyKey.NORMAL_MODE.ToString(),
                                                       MinPlayers = 20,
                                                       MinPlayersAccept = 20,
                                                   ...
                                                   new DifficultyLevels
                                                   {
                                                       Id = 3821,
                                                       ZoneSettingId = 2721,
                                                       UiString = Zone.UIString.INSTANCE_DIFFICULTY_HARD.ToString(),
                                                       MinLevel = 39,
                                                       DifficultyKey = Zone.DifficultyKey.HARD_MODE.ToString(),
                                                       MinPlayers = 20,
                                                       MinPlayersAccept = 20,
